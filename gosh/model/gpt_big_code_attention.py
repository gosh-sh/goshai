...
class GPTBigCodeAttention(nn.Module):
    def __init__(self, config, is_cross_attention=False, is_knn_attention=False, layer_idx=None):
        super().__init__()
        ...
        self.is_knn_attention = is_knn_attention
        ...
        if self.is_knn_attention:
            self.knn_attn = KNNMemoryAttention(self.num_heads, config.attn_pdrop)
    ...
    def forward(
        ...
        if self.is_knn_attention:
            attn_output = self.knn_attn(query, key, value, attn_output, knn_memory, add_knn_memory)
